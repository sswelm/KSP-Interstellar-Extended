...
namespace FNPlugin
{
    class InterstellarMagneticNozzleControllerFX : ResourceSuppliableModule, IFNEngineNoozle
    {
        ...
        [KSPField(groupName = GROUP, guiName = "#LOC_KSPIE_ThermalNozzleController_Radius", guiActiveEditor = true, guiUnits = "m")]
        public double radius = 2.5;
        [KSPField(groupName = GROUP, guiName = "#LOC_KSPIE_FusionEngine_partMass", guiActiveEditor = true, guiUnits = " t")]
