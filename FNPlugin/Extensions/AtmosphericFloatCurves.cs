namespace FNPlugin.Extensions
{
	public class AtmosphericFloatCurves
	{
		...
		private void InitializeHydrogenIonsCubeCm()
		{
			...
			HydrogenIonsPerCubeCm.Add(284f, 0);
			HydrogenIonsPerCubeCm.Add(285f, 1.00e+8f);
			HydrogenIonsPerCubeCm.Add(299f, 2.49e+8f);
			HydrogenIonsPerCubeCm.Add(312f, 4.40e+8f);
			HydrogenIonsPerCubeCm.Add(334f, 6.34e+8f);
			HydrogenIonsPerCubeCm.Add(359f, 8.83e+8f);
			HydrogenIonsPerCubeCm.Add(377f, 1.11e+9f);
			HydrogenIonsPerCubeCm.Add(396f, 1.26e+9f);
			HydrogenIonsPerCubeCm.Add(411f, 1.36e+9f);
			HydrogenIonsPerCubeCm.Add(437f, 1.51e+9f);
			HydrogenIonsPerCubeCm.Add(464f, 1.65e+9f);
			HydrogenIonsPerCubeCm.Add(504f, 1.78e+9f);
			HydrogenIonsPerCubeCm.Add(536f, 1.86e+9f);
			HydrogenIonsPerCubeCm.Add(588f, 2.00e+9f);
			HydrogenIonsPerCubeCm.Add(641f, 2.20e+9f);
			HydrogenIonsPerCubeCm.Add(678f, 2.40e+9f);
			HydrogenIonsPerCubeCm.Add(715f, 2.64e+9f);
			HydrogenIonsPerCubeCm.Add(754f, 2.94e+9f);
			HydrogenIonsPerCubeCm.Add(793f, 3.33e+9f);
			HydrogenIonsPerCubeCm.Add(829f, 3.76e+9f);
			HydrogenIonsPerCubeCm.Add(864f, 4.26e+9f);
			HydrogenIonsPerCubeCm.Add(904f, 4.97e+9f);
			HydrogenIonsPerCubeCm.Add(939f, 5.72e+9f);
			HydrogenIonsPerCubeCm.Add(968f, 6.43e+9f);
			HydrogenIonsPerCubeCm.Add(992f, 7.07e+9f);
			HydrogenIonsPerCubeCm.Add(1010f, 7.61e+9f);
			HydrogenIonsPerCubeCm.Add(1040f, 7.95e+9f);
			HydrogenIonsPerCubeCm.Add(1070f, 8.15e+9f);
			HydrogenIonsPerCubeCm.Add(1100f, 8.13e+9f);
			HydrogenIonsPerCubeCm.Add(1140f, 7.89e+9f);
			HydrogenIonsPerCubeCm.Add(1170f, 7.57e+9f);
			HydrogenIonsPerCubeCm.Add(1190f, 7.21e+9f);
			HydrogenIonsPerCubeCm.Add(1240f, 6.46e+9f);
			HydrogenIonsPerCubeCm.Add(2000f, 3.8e+7f);
			HydrogenIonsPerCubeCm.Add(4000f, 1.9e+5f);
			HydrogenIonsPerCubeCm.Add(8000f, 9.5e+2f);
			HydrogenIonsPerCubeCm.Add(16000f, 4.75f);
			HydrogenIonsPerCubeCm.Add(32000f, 2.375e-2f);
			HydrogenIonsPerCubeCm.Add(64000f, 0);
		}
		...
		private void InitialiseParticlesHeliumnCubePerMeter()
		{
			...
			ParticlesHeliumnPerCubePerCm.Add(16000.0f, 5.1225E-4f);
			ParticlesHeliumnPerCubePerCm.Add(32000.0f, 2.56125E-6f);
			ParticlesHeliumnPerCubePerCm.Add(64000.0f, 0);
		}
