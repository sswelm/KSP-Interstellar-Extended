...
namespace FNPlugin.Wasteheat
{
    ...
    class FNRadiator : ResourceSuppliableModule
    {
        ...
        public static void InitializeTemperatureColorChannels()
        {
            ...
            _redTempColorChannel.AddKey(1100, 255 / 255f); _greenTempColorChannel.AddKey(1100, 29 / 255f); _blueTempColorChannel.AddKey(1100, 0 / 255f);
            _redTempColorChannel.AddKey(1200, 255 / 255f); _greenTempColorChannel.AddKey(1200, 47 / 255f); _blueTempColorChannel.AddKey(1200, 0 / 255f);
            _redTempColorChannel.AddKey(1300, 255 / 255f); _greenTempColorChannel.AddKey(1300, 64 / 255f); _blueTempColorChannel.AddKey(1300, 0 / 255f);
            _redTempColorChannel.AddKey(1400, 255 / 255f); _greenTempColorChannel.AddKey(1400, 80 / 255f); _blueTempColorChannel.AddKey(1400, 0 / 255f);
            _redTempColorChannel.AddKey(1500, 255 / 255f); _greenTempColorChannel.AddKey(1500, 94 / 255f); _blueTempColorChannel.AddKey(1500, 0 / 255f);
            _redTempColorChannel.AddKey(1600, 255 / 255f); _greenTempColorChannel.AddKey(1600, 107 / 255f); _blueTempColorChannel.AddKey(1600, 0 / 255f);
            _redTempColorChannel.AddKey(1700, 255 / 255f); _greenTempColorChannel.AddKey(1700, 119 / 255f); _blueTempColorChannel.AddKey(1700, 0 / 255f);
            _redTempColorChannel.AddKey(1800, 255 / 255f); _greenTempColorChannel.AddKey(1800, 130 / 255f); _blueTempColorChannel.AddKey(1800, 0 / 255f);
            _redTempColorChannel.AddKey(1900, 255 / 255f); _greenTempColorChannel.AddKey(1900, 140 / 255f); _blueTempColorChannel.AddKey(1900, 0 / 255f);
            _redTempColorChannel.AddKey(2000, 255 / 255f); _greenTempColorChannel.AddKey(2000, 149 / 255f); _blueTempColorChannel.AddKey(2000, 0 / 255f);
            ...
            _redTempColorChannel.AddKey(2200, 255 / 255f); _greenTempColorChannel.AddKey(2200, 164 / 255f); _blueTempColorChannel.AddKey(2200, 0 / 255f);
            _redTempColorChannel.AddKey(2300, 255 / 255f); _greenTempColorChannel.AddKey(2300, 170 / 255f); _blueTempColorChannel.AddKey(2300, 0 / 255f);
            _redTempColorChannel.AddKey(2400, 255 / 255f); _greenTempColorChannel.AddKey(2400, 175 / 255f); _blueTempColorChannel.AddKey(2400, 0 / 255f);
            _redTempColorChannel.AddKey(2500, 255 / 255f); _greenTempColorChannel.AddKey(2500, 180 / 255f); _blueTempColorChannel.AddKey(2500, 0 / 255f);
            _redTempColorChannel.AddKey(2600, 255 / 255f); _greenTempColorChannel.AddKey(2600, 184 / 255f); _blueTempColorChannel.AddKey(2600, 1 / 255f);
            _redTempColorChannel.AddKey(2700, 255 / 255f); _greenTempColorChannel.AddKey(2700, 188 / 255f); _blueTempColorChannel.AddKey(2700, 3 / 255f);
            _redTempColorChannel.AddKey(2800, 255 / 255f); _greenTempColorChannel.AddKey(2800, 192 / 255f); _blueTempColorChannel.AddKey(2800, 7 / 255f);
            _redTempColorChannel.AddKey(2900, 255 / 255f); _greenTempColorChannel.AddKey(2900, 196 / 255f); _blueTempColorChannel.AddKey(2900, 13 / 255f);
            _redTempColorChannel.AddKey(3000, 255 / 255f); _greenTempColorChannel.AddKey(3000, 200 / 255f); _blueTempColorChannel.AddKey(3000, 21 / 255f);
            _redTempColorChannel.AddKey(3100, 255 / 255f); _greenTempColorChannel.AddKey(3100, 204 / 255f); _blueTempColorChannel.AddKey(3100, 30 / 255f);
            _redTempColorChannel.AddKey(3200, 255 / 255f); _greenTempColorChannel.AddKey(3200, 207 / 255f); _blueTempColorChannel.AddKey(3200, 40 / 255f);
            _redTempColorChannel.AddKey(3300, 255 / 255f); _greenTempColorChannel.AddKey(3300, 210 / 255f); _blueTempColorChannel.AddKey(3300, 51 / 255f);
            _redTempColorChannel.AddKey(3400, 255 / 255f); _greenTempColorChannel.AddKey(3400, 213 / 255f); _blueTempColorChannel.AddKey(3400, 63 / 255f);
            _redTempColorChannel.AddKey(3500, 255 / 255f); _greenTempColorChannel.AddKey(3500, 216 / 255f); _blueTempColorChannel.AddKey(3500, 76 / 255f);
            _redTempColorChannel.AddKey(3600, 255 / 255f); _greenTempColorChannel.AddKey(3600, 219 / 255f); _blueTempColorChannel.AddKey(3600, 90 / 255f);
            _redTempColorChannel.AddKey(3700, 255 / 255f); _greenTempColorChannel.AddKey(3700, 221 / 255f); _blueTempColorChannel.AddKey(3700, 105 / 255f);
            _redTempColorChannel.AddKey(3800, 255 / 255f); _greenTempColorChannel.AddKey(3800, 224 / 255f); _blueTempColorChannel.AddKey(3800, 120 / 255f);
            _redTempColorChannel.AddKey(3900, 255 / 255f); _greenTempColorChannel.AddKey(3900, 226 / 255f); _blueTempColorChannel.AddKey(3900, 135 / 255f);
            _redTempColorChannel.AddKey(4000, 255 / 255f); _greenTempColorChannel.AddKey(4000, 230 / 255f); _blueTempColorChannel.AddKey(4000, 150 / 255f);
            _redTempColorChannel.AddKey(4100, 255 / 255f); _greenTempColorChannel.AddKey(4100, 235 / 255f); _blueTempColorChannel.AddKey(4100, 165 / 255f);
            _redTempColorChannel.AddKey(4200, 255 / 255f); _greenTempColorChannel.AddKey(4200, 240 / 255f); _blueTempColorChannel.AddKey(4200, 180 / 255f);
            _redTempColorChannel.AddKey(4300, 255 / 255f); _greenTempColorChannel.AddKey(4300, 245 / 255f); _blueTempColorChannel.AddKey(4300, 195 / 255f);
            _redTempColorChannel.AddKey(4400, 255 / 255f); _greenTempColorChannel.AddKey(4400, 250 / 255f); _blueTempColorChannel.AddKey(4400, 210 / 255f);
