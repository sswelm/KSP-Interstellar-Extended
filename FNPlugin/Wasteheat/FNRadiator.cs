...
namespace FNPlugin.Wasteheat
{
    ...
    class FNRadiator : ResourceSuppliableModule
    {
        ...
        public static void InitializeTemperatureColorChannels()
        {
            ...
            _redTempColorChannel.AddKey(2500, 255 / 255f); _greenTempColorChannel.AddKey(2500, 180 / 255f); _blueTempColorChannel.AddKey(2500, 1 / 255f);
            _redTempColorChannel.AddKey(2600, 255 / 255f); _greenTempColorChannel.AddKey(2600, 184 / 255f); _blueTempColorChannel.AddKey(2600, 3 / 255f);
            _redTempColorChannel.AddKey(2700, 255 / 255f); _greenTempColorChannel.AddKey(2700, 188 / 255f); _blueTempColorChannel.AddKey(2700, 7 / 255f);
            _redTempColorChannel.AddKey(2800, 255 / 255f); _greenTempColorChannel.AddKey(2800, 192 / 255f); _blueTempColorChannel.AddKey(2800, 13 / 255f);
            _redTempColorChannel.AddKey(2900, 255 / 255f); _greenTempColorChannel.AddKey(2900, 196 / 255f); _blueTempColorChannel.AddKey(2900, 21 / 255f);
            _redTempColorChannel.AddKey(3000, 255 / 255f); _greenTempColorChannel.AddKey(3000, 200 / 255f); _blueTempColorChannel.AddKey(3000, 30 / 255f);
            _redTempColorChannel.AddKey(3100, 255 / 255f); _greenTempColorChannel.AddKey(3100, 204 / 255f); _blueTempColorChannel.AddKey(3100, 40 / 255f);
            _redTempColorChannel.AddKey(3200, 255 / 255f); _greenTempColorChannel.AddKey(3200, 207 / 255f); _blueTempColorChannel.AddKey(3200, 51 / 255f);
            _redTempColorChannel.AddKey(3300, 255 / 255f); _greenTempColorChannel.AddKey(3300, 210 / 255f); _blueTempColorChannel.AddKey(3300, 63 / 255f);
            _redTempColorChannel.AddKey(3400, 255 / 255f); _greenTempColorChannel.AddKey(3400, 213 / 255f); _blueTempColorChannel.AddKey(3400, 76 / 255f);
            _redTempColorChannel.AddKey(3500, 255 / 255f); _greenTempColorChannel.AddKey(3500, 216 / 255f); _blueTempColorChannel.AddKey(3500, 90 / 255f);
            _redTempColorChannel.AddKey(3600, 255 / 255f); _greenTempColorChannel.AddKey(3600, 219 / 255f); _blueTempColorChannel.AddKey(3600, 105 / 255f);
            _redTempColorChannel.AddKey(3700, 255 / 255f); _greenTempColorChannel.AddKey(3700, 221 / 255f); _blueTempColorChannel.AddKey(3700, 120 / 255f);
            _redTempColorChannel.AddKey(3800, 255 / 255f); _greenTempColorChannel.AddKey(3800, 224 / 255f); _blueTempColorChannel.AddKey(3800, 135 / 255f);
            _redTempColorChannel.AddKey(3900, 255 / 255f); _greenTempColorChannel.AddKey(3900, 226 / 255f); _blueTempColorChannel.AddKey(3900, 150 / 255f);
            _redTempColorChannel.AddKey(4000, 255 / 255f); _greenTempColorChannel.AddKey(4000, 230 / 255f); _blueTempColorChannel.AddKey(4000, 165 / 255f);
            _redTempColorChannel.AddKey(4100, 255 / 255f); _greenTempColorChannel.AddKey(4100, 235 / 255f); _blueTempColorChannel.AddKey(4100, 180 / 255f);
            _redTempColorChannel.AddKey(4200, 255 / 255f); _greenTempColorChannel.AddKey(4200, 240 / 255f); _blueTempColorChannel.AddKey(4200, 195 / 255f);
