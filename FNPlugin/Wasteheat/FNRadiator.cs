...
namespace FNPlugin.Wasteheat
{
    ...
    class FNRadiator : ResourceSuppliableModule
    {
        ...
        public static void InitializeTemperatureColorChannels()
        {
            ...
            _redTempColorChannel.AddKey(2400, 255 / 255f); _greenTempColorChannel.AddKey(2400, 178 / 255f); _blueTempColorChannel.AddKey(2400, 0 / 255f);
            _redTempColorChannel.AddKey(2500, 255 / 255f); _greenTempColorChannel.AddKey(2500, 183 / 255f); _blueTempColorChannel.AddKey(2500, 1 / 255f);
            ...
            _redTempColorChannel.AddKey(2700, 255 / 255f); _greenTempColorChannel.AddKey(2700, 191 / 255f); _blueTempColorChannel.AddKey(2700, 7 / 255f);
            _redTempColorChannel.AddKey(2800, 255 / 255f); _greenTempColorChannel.AddKey(2800, 195 / 255f); _blueTempColorChannel.AddKey(2800, 13 / 255f);
            _redTempColorChannel.AddKey(2900, 255 / 255f); _greenTempColorChannel.AddKey(2900, 199 / 255f); _blueTempColorChannel.AddKey(2900, 21 / 255f);
            _redTempColorChannel.AddKey(3000, 255 / 255f); _greenTempColorChannel.AddKey(3000, 203 / 255f); _blueTempColorChannel.AddKey(3000, 30 / 255f);
            _redTempColorChannel.AddKey(3100, 255 / 255f); _greenTempColorChannel.AddKey(3100, 207 / 255f); _blueTempColorChannel.AddKey(3100, 40 / 255f);
            _redTempColorChannel.AddKey(3200, 255 / 255f); _greenTempColorChannel.AddKey(3200, 211 / 255f); _blueTempColorChannel.AddKey(3200, 51 / 255f);
            _redTempColorChannel.AddKey(3300, 255 / 255f); _greenTempColorChannel.AddKey(3300, 215 / 255f); _blueTempColorChannel.AddKey(3300, 63 / 255f);
            _redTempColorChannel.AddKey(3400, 255 / 255f); _greenTempColorChannel.AddKey(3400, 218 / 255f); _blueTempColorChannel.AddKey(3400, 76 / 255f);
            _redTempColorChannel.AddKey(3500, 255 / 255f); _greenTempColorChannel.AddKey(3500, 222 / 255f); _blueTempColorChannel.AddKey(3500, 90 / 255f);
            _redTempColorChannel.AddKey(3600, 255 / 255f); _greenTempColorChannel.AddKey(3600, 226 / 255f); _blueTempColorChannel.AddKey(3600, 105 / 255f);
            _redTempColorChannel.AddKey(3700, 255 / 255f); _greenTempColorChannel.AddKey(3700, 230 / 255f); _blueTempColorChannel.AddKey(3700, 120 / 255f);
            _redTempColorChannel.AddKey(3800, 255 / 255f); _greenTempColorChannel.AddKey(3800, 233 / 255f); _blueTempColorChannel.AddKey(3800, 135 / 255f);
            _redTempColorChannel.AddKey(3900, 255 / 255f); _greenTempColorChannel.AddKey(3900, 236 / 255f); _blueTempColorChannel.AddKey(3900, 150 / 255f);
            _redTempColorChannel.AddKey(4000, 255 / 255f); _greenTempColorChannel.AddKey(4000, 240 / 255f); _blueTempColorChannel.AddKey(4000, 165 / 255f);
            _redTempColorChannel.AddKey(4100, 255 / 255f); _greenTempColorChannel.AddKey(4100, 244 / 255f); _blueTempColorChannel.AddKey(4100, 180 / 255f);
